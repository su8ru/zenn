...
frourio の API 定義部分は、aspida と共通仕様になっています。

![aspida](https://aspida.github.io/aspida/logos/svg/black.svg =400x)
...
:::message
frourio ではパスのディレクトリ内にコントローラーを書くため、旧来の `/v1/users.ts` のような記法はサポートされていません。
:::
